						...
						<div class="panel-container">
							...
							<div class="panel-content">
								...
								<div class="form-group">
									...
									<input name="phone" type="tel" id="simpleinput" class="form-control" pattern="[0-9] [0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="1 123-1234-1234">
								</div>
							...
							<div class="panel-content">
								...
								<div class="form-group">
									...
									<select name="status" class="form-control" id="example-select">
										...
										<option value="not worry">Не беспокоить</option>
									</select>
								</div>
