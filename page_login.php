		...
		<div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
			...
			<form action="page_login_handler.php" method="POST">
				<div class="form-group">
					...
					<input required name="email" type="email" id="username" class="form-control" placeholder="Эл. адрес">
				</div>
				<div class="form-group">
				...
				<div class="form-group text-left">
					<div class="custom-control custom-checkbox">
						<input name="rememberme" value="true" type="checkbox" class="custom-control-input" id="rememberme">
